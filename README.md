...
```
dependencies {
    implementation 'ro.andob.jpegturbo:bindings-api:1.1.6'
    implementation 'ro.andob.jpegturbo:bindings-jpegturbo:1.1.6'
    implementation 'ro.andob.jpegturbo:bindings-mozjpeg:1.1.6'
}
```
